    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center pt-8">
        ...
        <div class="lg:col-span-5 flex justify-center items-center relative select-none">
            ...
            <svg class="w-full max-w-[380px] h-auto drop-shadow-[0_0_25px_rgba(205,95,248,0.25)] animate-pulse" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M220 300L280 140" stroke="#38debb" stroke-width="6" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="space-y-12 pt-16 border-t border-outline/10">
        ...
        <div class="text-center space-y-6 pt-10">
            ...
            <div class="flex justify-center items-center gap-5">
                ...
                <!-- LinkedIn -->
                <a href="https://www.linkedin.com/in/chijindu-nwokeohuru/" target="_blank" class="w-12 h-12 rounded-full glass-panel border border-outline/25 flex justify-center items-center text-on-surface hover:text-white hover:border-primary/60 hover:shadow-[0_0_15px_rgba(205,95,248,0.4)] transition-all duration-300 cursor-pointer">
                    <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.779-1.75-1.75s.784-1.75 1.75-1.75 1.75.779 1.75 1.75-.784 1.75-1.75 1.75zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <!-- Twitter -->
                <a href="https://x.com/ChijinduHQ" target="_blank" class="w-12 h-12 rounded-full glass-panel border border-outline/25 flex justify-center items-center text-on-surface hover:text-white hover:border-primary/60 hover:shadow-[0_0_15px_rgba(205,95,248,0.4)] transition-all duration-300 cursor-pointer">
                    <svg class="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <!-- Mail -->
                <a href="mailto:chijindu.nwokeohuru@gmail.com" class="w-12 h-12 rounded-full glass-panel border border-outline/25 flex justify-center items-center text-on-surface hover:text-white hover:border-primary/60 hover:shadow-[0_0_15px_rgba(205,95,248,0.4)] transition-all duration-300 cursor-pointer">
